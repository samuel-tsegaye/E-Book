...
namespace E_Book {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class documentsDataTable : global::System.Data.TypedTableBase<documentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public documentsRow AdddocumentsRow(string Book_Title, string Author, string Quantity, string FileName, string Catagories, string Extension) {
...
namespace E_Book.DataSet1TableAdapters {
    ...
    public partial class documentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [documents] WHERE (([ID] = @Original_ID) AND ((@IsNull_Book_Title = 1 AND [Book_Title] IS NULL) OR ([Book_Title] = @Original_Book_Title)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_FileName = 1 AND [FileName] IS NULL) OR ([FileName] = @Original_FileName)) AND ((@IsNull_Catagories = 1 AND [Catagories] IS NULL) OR ([Catagories] = @Original_Catagories)) AND ((@IsNull_Extension = 1 AND [Extension] IS NULL) OR ([Extension] = @Original_Extension)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [documents] ([Book_Title], [Author], [Quantity], [FileName], [Catagories], [Extension]) VALUES (@Book_Title, @Author, @Quantity, @FileName, @Catagories, @Extension);
SELECT ID, Book_Title, Author, Quantity, FileName, Catagories, Extension FROM documents WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [documents] SET [Book_Title] = @Book_Title, [Author] = @Author, [Quantity] = @Quantity, [FileName] = @FileName, [Catagories] = @Catagories, [Extension] = @Extension WHERE (([ID] = @Original_ID) AND ((@IsNull_Book_Title = 1 AND [Book_Title] IS NULL) OR ([Book_Title] = @Original_Book_Title)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_FileName = 1 AND [FileName] IS NULL) OR ([FileName] = @Original_FileName)) AND ((@IsNull_Catagories = 1 AND [Catagories] IS NULL) OR ([Catagories] = @Original_Catagories)) AND ((@IsNull_Extension = 1 AND [Extension] IS NULL) OR ([Extension] = @Original_Extension)));
SELECT ID, Book_Title, Author, Quantity, FileName, Catagories, Extension FROM documents WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, Book_Title, Author, Quantity, FileName, Catagories, Extension\r\n" +
                "FROM            documents";
        ...
        public virtual int Delete(int Original_ID, string Original_Book_Title, string Original_Author, string Original_Quantity, string Original_FileName, string Original_Catagories, string Original_Extension) {
            ...
            if ((Original_Catagories == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((string)(Original_Catagories));
            }
            if ((Original_Extension == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((string)(Original_Extension));
            }
        ...
        public virtual int Insert(string Book_Title, string Author, string Quantity, string FileName, string Catagories, string Extension) {
            if ((Book_Title == null)) {
            ...
            if ((Catagories == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(Catagories));
            }
            if ((Extension == null)) {
        ...
        public virtual int Update(string Book_Title, string Author, string Quantity, string FileName, string Catagories, string Extension, int Original_ID, string Original_Book_Title, string Original_Author, string Original_Quantity, string Original_FileName, string Original_Catagories, string Original_Extension, int ID) {
            if ((Book_Title == null)) {
            ...
            if ((Catagories == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Catagories));
            }
            if ((Extension == null)) {
            ...
            if ((Original_Catagories == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_Catagories));
            }
            if ((Original_Extension == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_Extension));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Book_Title, string Author, string Quantity, string FileName, string Catagories, string Extension, int Original_ID, string Original_Book_Title, string Original_Author, string Original_Quantity, string Original_FileName, string Original_Catagories, string Original_Extension) {
            return this.Update(Book_Title, Author, Quantity, FileName, Catagories, Extension, Original_ID, Original_Book_Title, Original_Author, Original_Quantity, Original_FileName, Original_Catagories, Original_Extension, Original_ID);
        }
    }
